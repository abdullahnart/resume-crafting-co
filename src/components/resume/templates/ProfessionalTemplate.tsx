...
export function ProfessionalTemplate({ data, accentColor, design }: TemplateProps) {
  ...
  return (
    <div className="text-[11px] text-gray-900" style={{ lineHeight: d.lineHeight }}>
      <div data-pdf-section className={`p-6 text-white ${alignClass(d.headerAlign)}`} style={{ backgroundColor: accentColor }}>
      ...
      <div className="p-6 space-y-4">
        {summary && (
          <div data-pdf-section className="bg-gray-50 p-3 rounded">
