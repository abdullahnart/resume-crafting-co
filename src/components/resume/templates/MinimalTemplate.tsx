...
export function MinimalTemplate({ data, accentColor, design }: TemplateProps) {
  ...
  return (
    <div className="text-[11px] text-gray-800" style={{ lineHeight: d.lineHeight }}>
      <div data-pdf-section className={`mb-8 ${alignClass(d.headerAlign)}`}>
      ...
      {experience.length > 0 && (
        <div className="mb-6">
          ...
          {experience.map(exp => (
            <div key={exp.id} data-pdf-section className="py-3 border-b border-gray-100">
      ...
      {education.length > 0 && (
        <div className="mb-6">
          ...
          <div className="border-t border-gray-200" />
          {education.map(edu => (
            <div key={edu.id} data-pdf-section className="py-2 border-b border-gray-100">
